        ...
        <div className="  flex justify-center items-center py-2">
            <form className="max-w-[480px] w-full px-4" onSubmit={onSubmit}>
                <div className="relative opacity-100"  >
                    <input type="text" name="searchInput" className="w-full border h-12 shadow p-4 rounded-full" placeholder="Search..." onChange={ (e) => setInput(e.target.value)} />
                    <button type="submit">
                        <svg className="text-purple-500 h-5 w-5 absolute top-3.5 right-3 fill-current"
